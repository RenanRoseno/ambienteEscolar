    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <header class="bg-white shadow">
            <div class="max-w-7xl py-6 px-4 sm:px-6 lg:px-2"> 
             <center><h4>AVALIAÇÕES</h4></center>           
         </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg" style="padding: 20px;">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <center>
                            <a href="{{ route('avaliacoes.cadastrar')}}"class="btn btn-lg"><i class="fas fa-graduation-cap fa-10x"></i><br>
                    ...
                    <div class="col-md-6">
                        <center>
                            <a href=" {{ route('avaliacoes.listar')}}"class="btn btn-lg">
                                <i class="fas fa-list-alt fa-10x"></i><br>
                                LISTAR AVALIAÇÕES
                            </center>
                        </a>
                    </div>
